...
// ✅ Insere novo usuário
$sql = "INSERT INTO usuarios (nome, email, celular, cpf, cep, endereco, cidade, estado, senha, token_confirmacao, status_confirmacao) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pendente')";
$stmt = $mysqli->prepare($sql);
$stmt->bind_param("ssssssssss", $nome, $email, $celular, $cpf, $cep, $endereco, $cidade, $estado, $senha_hashed, $token_confirmacao);
